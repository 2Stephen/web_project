<template>
            ...
            <el-row>
              ...
              <el-col :span="8">
                <div class="avatar-section">
                    <el-avatar shape="square" :size="150" :fit='pic' :src="url"></el-avatar>
                  <div>我的头像</div>
                </div>
              </el-col>
              <!-- 右侧三分之二，展示 -->
  ...
  export default {
    ...
    computed: {
    username() {
      return this.$store.getters.username; // 获取用户名
    },
    email() {
      return this.$store.getters.email; // 获取邮箱
    },
    birthday() {
      return this.$store.getters.birthday; // 获取生日
    },
    balance() {
      return this.$store.getters.balance; // 获取余额
    }
  },
    data() {
      return {
